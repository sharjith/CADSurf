...
FontCreate(HDC        hdc,       /* I - Device Context */
    ...
    {
    _GLFONT *font;                /* Font data pointer */
    HFONT  fontid;               /* Windows font ID */
    int    charset;              /* Character set code */

    /* Allocate memory */
    if ((font = (_GLFONT*)calloc(1, sizeof(_GLFONT))) == (_GLFONT *)0)
        return ((_GLFONT *)0);
...
void
FontDelete(_GLFONT *font) /* I - Font to delete */
    {
    if (font == (_GLFONT *)0)
        return;
...
void
FontPuts(_GLFONT     *font, /* I - Font to use */
         const char *s)    /* I - String to display */
    {
    if (font == (_GLFONT *)0 || s == NULL)
        return;
...
void
FontPrintf(_GLFONT     *font,   /* I - Font to use */
    ...
    float           width;       /* Width of string in pixels */

    if (font == (_GLFONT *)0 || format == (char *)0)
        return;
